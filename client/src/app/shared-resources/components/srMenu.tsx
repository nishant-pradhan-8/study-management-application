...
export default function SrMenu({
  ...
  const {user, isDeleting, setIsDeleting} = useUserContext()
    const {handleDeleteSharedFile} = useDeleteSharedNotes(user, setIsDeleting, sharedNotes, setSharedNotes)
  ...
  const openTransferDialog = () => {
    const selectedNote:SharedNotes | null = sharedNotes?.find(note=>note._id===selectedMenuId) || null
    if(!selectedNote){
