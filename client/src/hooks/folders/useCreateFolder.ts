...
export default function useCreateFolder(folders:Folder[] | null,setFolders:Dispatch<SetStateAction<Folder[] | null>>){
    ...
    return{newFolderName, setNewFolderName,folderNameError,inputRef, handleCreateFolder}
}